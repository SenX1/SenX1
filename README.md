...
*   **[Boxing Video Action Recognition & Attribute Classification](https://github.com/SenX1/boxing-hack--)**
    *   *Task:* Automatic classification of boxing punches and their attributes on high-resolution video.
    *   *Solution:* Implemented a pipeline using YOLOv11 Pose and BotSort for keypoint tracking, custom kinematic feature engineering, an ensemble of Temporal Convolutional Networks (TCN) for event detection, and a multi-head MLP for multi-attribute classification (hand, target, type, effectiveness) with Non-Maximum Suppression (NMS) post-processing.
